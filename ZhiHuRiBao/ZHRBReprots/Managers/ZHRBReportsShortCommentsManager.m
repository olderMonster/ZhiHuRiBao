//
//  ZHRBReportsShortCommentsManager.m
//  ZhiHuRiBao
//
...
@implementation ZHRBReportsShortCommentsManager
...
- (NSString *)methodName{
    ...
    NSString *url = [NSString stringWithFormat:@"story/%@/short-comments",self.reportsId];
    return url;
}
